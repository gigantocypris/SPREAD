...
The diffraction spot shoeboxes generated by `dials` can be used in further machine learning pipelines. By demonstrating the known forward physics and conventional methods of indexing and integration, we aim to spark discussion amongst machine learning researchers and crystallographers to create improved processing methods for SPREAD. We outline promising directions in our [paper](https://arxiv.org/abs/2307.01901), please get in touch if you would like to discuss further!
